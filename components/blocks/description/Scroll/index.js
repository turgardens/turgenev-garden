...
import BackgroundFirstApple from "../../../../public/img/decorative/element-8.webp"
import BackgroundSecondApple from "../../../../public/img/decorative/element-7.webp"
import BackgroundThirdApple from "../../../../public/img/decorative/element-2.webp"

// Движение объектов при скролле
export default function Scroll({ scrollIcon }) {
    ...
    return (
        <div className={styles.block}>
            ...
            {!scrollIcon &&
                <>
                    <div className={styles.imageContainerLeft} ref={imgLeftRef} style={{ opacity: 1 }}>
                        <Image className={styles.image} src={BackgroundFirstApple} width="250" height="255" />
                    </div>

                    <div className={styles.imageContainerCenter} ref={imgCenterRef} style={{ opacity: 1 }}>
                        <Image className={styles.image} src={BackgroundThirdApple} width="200" height="195" />
                    </div>

                    <div className={styles.imageContainerRight} ref={imgRightRef} style={{ opacity: 1 }}>
                        <Image className={styles.image} src={BackgroundSecondApple} width="100" height="100" />
                    </div>
                </>
            }
