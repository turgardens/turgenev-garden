                ...
                <div className={styles.aboutDescriptionWrapper}>
                    ...
                    <div className={styles.aboutDescriptionBlock}>
                        <div className={styles.aboutDescriptionContent}>
                            ...
                            <p className='text'>
                                Производственная мощность нашего предприятия составляет примерно 1400 упаковок натурального сока в сутки. Сегодня наше предприятие уже перерабатывает более 5 тонн свежих яблок в сутки
                            </p>
                        </div>
